...
export const getServerSideProps = withSession(async ({ req, res, query }) => {
    ...
    const response = await axios.get('https://api.spoonacular.com/recipes/complexSearch', {
      params: {
        apiKey,
        query: query.q, // Assuming your query parameter is named 'q'
    ...
    return {
      props: {
        user: user || null,
        recipes: response.data.results // Assuming your API response contains 'results' field with an array of recipes
      }
    };
  });
